...
namespace UiPathTeam.StatusProgress.Activities
{
    ...
    public class ModalDataTable : NativeActivity
    {
        ...
        public InArgument<Color> ColorBorder { get; set; } = Color.OrangeRed;

        [Category("Input"), Description("Background Color.  Default: Black")]
        public InArgument<Color> ColorBackground { get; set; } = Color.Black;

        [Category("Input"), Description("Text Color.  Default: White")]
        public InArgument<Color> ColorText { get; set; } = Color.White;

        [Category("Input"), Description("Close Button Color.  Default: Red")]
        public InArgument<Color> ColorButton { get; set; } = Color.Red;
